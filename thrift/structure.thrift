...
namespace cpp concrete.structure
...
struct SpanLink {
  ...
  /*
   * The target of this SpanLink object, represented
   * as a UUID of another object within Concrete.
   *
   * Minimally, either this field or 'externalTarget'
   * should be present.
   */
  2: optional uuid.UUID concreteTarget

  /*
   * The target of this SpanLink object when it is not
   * a Concrete object. For example, this could represent
   * a URL of a web page outside of Concrete.
   *
   * Minimally, either this field or 'concreteTarget'
   * should be present.
   */
  3: optional string externalTarget

  /*
   * The type of this SpanLink object.
   */
  4: required string linkType
}
...
struct Tokenization {
  ...
  /*
   * A list of all SpanLinks present in this Tokenization.
   */
  9: optional list<SpanLink> spanLinkList
}
